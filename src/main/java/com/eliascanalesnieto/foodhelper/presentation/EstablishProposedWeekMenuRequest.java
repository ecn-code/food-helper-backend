...
@Schema(name = "CreateMenuRequest", description = "Request used to create a menu from planning, assign its cost, and optionally attach the people assigned to it")
public record EstablishProposedWeekMenuRequest(
        ...
        @Schema(description = "Optional identifiers of the people assigned to the menu when it is established.", example = "[1, 7]")
        List<Long> personIds
) {
